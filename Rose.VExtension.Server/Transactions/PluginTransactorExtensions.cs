...
namespace Rose.VExtension.Server.Transactions
{
    public static class PluginTransactorExtensions
    {
        ...
        public static PluginsSyncResult Sync(this IPluginTransactor transactor)
        {
            return transactor.Sync(new PluginsPhysicalStatusProvider(transactor.Repository, transactor.Out));
        }
    }
}