...
namespace Rose.VExtension.PluginSystem.Activation.RuntimeActivation
{
    ...
    {
        public CSPluginPlatform(Plugin plugin, IConfigurationItem platformActivityItem)
        {
            Plugin = plugin;
        ...
        public IPluginActivity CreateActivity()
        {
            ...
            try
            {
                var domain = Activator.CreateInstance(type) as IPluginActivity;
                domain.Plugin = Plugin;
                domain.Name = this.GetActivityName();
                domain.Platform = this;
                return domain;
